                ...
                <button class="location-header-pill <?php echo $shop_color_class; ?>" onclick="openLocationModal()" type="button"
                    ...
                    <span class="location-header-text">
                        <span class="location-header-sub">
                            <?php echo t('Magasin sélectionné', 'Selected Store'); ?> <i class="fas fa-chevron-down loc-arrow"></i>
                        </span>
            ...
            <div class="language-switcher desktop-nav-item">
                ...
                <div class="lang-dropdown" id="userDropdown">
                    <?php if ($this->session->userdata('user_id')): ?>
                        ...
                        <a href="<?php echo base_url('user/account'); ?>"><?php echo t('Mes Commandes', 'My Orders'); ?></a>
